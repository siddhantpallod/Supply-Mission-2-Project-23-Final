...
function setup() {
	...
	boxDbody = Bodies.rectangle(400,650,200,20,{isStatic : true});
	boxLbody = Bodies.rectangle(300,610,20,100,{isStatic : true});
	boxRbody = Bodies.rectangle(500,610,20,100,{isStatic : true});
